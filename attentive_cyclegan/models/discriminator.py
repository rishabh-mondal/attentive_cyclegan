...
class Discriminator(nn.Module):
    ...
    def __init__(self, in_channels=3, features=[64, 128, 256, 512], use_attention=True):
        ...
        for i, feature in enumerate(features[1:]):
            layers.append(DiscriminatorBlock(in_channels, feature, stride=2 if feature != features[-1] else 1))
        ...
        self.final_layer = spectral_norm(nn.Conv2d(in_channels, 1, kernel_size=4, stride=1, padding=1))
